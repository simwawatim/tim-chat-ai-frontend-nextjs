        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
                Meet Tim Chat AI — Your Smart Conversation Partner
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
               Tim Chat AI helps you automate, analyze, and engage in conversations like never before. Whether you're managing support, brainstorming ideas, or just chatting—Tim's got your back.
            </p>
